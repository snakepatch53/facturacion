...
<head>
    ...
    <link rel="stylesheet" href="<?= $proyect['root_css'] ?>compras.css">
            ...
            <form class="ideaform-venta" action="#" method="POST" onsubmit="return false" id="formData">
                ...
                <section class="usuario ideasection open_" id="sectionUser">
                    <div class="head">
                        ...
                        <a href="./proveedor" target="_blank" class="ideabutton" id="inputNewButton" style="max-width: 150px;">
                            <img src="view/src/icon/truck.png">
                    ...
                    <div class="ideaform ideaform-cliente _client-data-open" id="ideaform-cliente">
                        ...
                        <div class="body client-data-no">
                            <div class="campo">
                                <input class="disabled" type="text" placeholder="Seleccione un proveedor!" disabled>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="ideaform">
                        ...
                        <div class="productos">
                            ...
                            <div class="form-producto">
                                ...
                                <input class="input" name="producto_comision" type="number" placeholder="Comision de Venta $">
                                <input class="input" name="producto_precio" type="number" placeholder="Precio Unitario $">
...
<foot>
    ...
    <script src="<?= $proyect['root_js'] ?>compras.js"></script>
</foot>
